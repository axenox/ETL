<?php
namespace axenox\ETL\Behaviors;

use axenox\ETL\Common\AbstractETLPrototype;
use axenox\ETL\Common\DataCheckWithStepNote;
 ...
 * 
 */
class StepValidatingBehavior extends AbstractValidatingBehavior
{
    ...
    protected function generateDataChecks(UxonObject $uxonObject): DataCheckListInterface
    {
        ...
        foreach ($uxonObject as $uxon) {
            $dataCheckList->add(new DataCheckWithStepNote($this->getWorkbench(), $uxon));
        }

        return $dataCheckList;
    }
    
    public function setStep(AbstractETLPrototype $step)
    {
